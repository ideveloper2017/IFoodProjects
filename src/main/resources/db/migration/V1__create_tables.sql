...
(
    ...
    created_date TIMESTAMP WITHOUT TIME ZONE,
    updated_date TIMESTAMP WITHOUT TIME ZONE,
    CONSTRAINT pk_ss_country PRIMARY KEY (id)
);
...
(
    ...
    num                   INTEGER,
    stop_list             BOOLEAN,
    available_time_starts time WITHOUT TIME ZONE,
    available_time_ends   time WITHOUT TIME ZONE,
    created_date          TIMESTAMP WITHOUT TIME ZONE,
    updated_date          TIMESTAMP WITHOUT TIME ZONE,
...
CREATE TABLE ss_modifiers
(
    id           INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    name         VARCHAR(255),
    created_date TIMESTAMP WITHOUT TIME ZONE,
    updated_date TIMESTAMP WITHOUT TIME ZONE,
    CONSTRAINT pk_ss_modifiers PRIMARY KEY (id)
);

CREATE TABLE ss_payment_method
(
    id           INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    name         VARCHAR(255),
    created_date TIMESTAMP WITHOUT TIME ZONE,
    updated_date TIMESTAMP WITHOUT TIME ZONE,
    CONSTRAINT pk_ss_payment_method PRIMARY KEY (id)
);
...
(
    ...
    created_date TIMESTAMP WITHOUT TIME ZONE,
    updated_date TIMESTAMP WITHOUT TIME ZONE,
    CONSTRAINT pk_ss_settings PRIMARY KEY (id)
);
